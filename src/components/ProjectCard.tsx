...
export const ProjectCard = ({ project }: { project: Project }) => {
  return (
    <div className="w-1/3 2xl:w-1/5 relative group">
      ...
      <div className="absolute h-full w-full transition ease-linear top-4 left-2 md:top-12 md:left-4 lg:top-16 lg:left-6 xl:top-20 xl:left-8 2xl:left-10 opacity-0 group-hover:opacity-90">
